...
agents_amount_testing = [10,20,30,40,50,100,200,500,1000,2000]
episodes_amount_testing = [10, 20, 50, 100, 500]
...
with open("tests/runtime_test.csv", "w") as f:
    ...
    for agents_amount in agents_amount_testing:
        ...
        for i in range(episodes_amount):
            ...
            print(f"Aktiver Agent: {agent_id}, Existiert in env.agents? {agent_id in env.agents}")
